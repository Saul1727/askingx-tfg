      ...
      <div className="relative bg-white w-full max-w-md max-h-[90vh] rounded-xl shadow-2xl overflow-y-auto animate-in zoom-in duration-300">
        ...
        <form onSubmit={handleSubmit} className="p-6 flex flex-col space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-semibold text-gray-700">Organización o Solicitante <span className="text-red-500">*</span></label>
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-semibold text-gray-700">Dominio de Ayuda <span className="text-red-500">*</span></label>
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-semibold text-gray-700">Título de la Petición <span className="text-red-500">*</span></label>
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-semibold text-gray-700">Tipo de Recurso <span className="text-red-500">*</span></label>
          ...
          {formData.type === 'THINGS' && (
            <div className="p-4 bg-blue-50 rounded-lg space-y-3">
              <label className="text-xs font-bold text-blue-700 uppercase">Cantidad Necesaria <span className="text-red-500">*</span></label>
          ...
          {formData.type === 'TIME' && (
            <div className="p-4 bg-green-50 rounded-lg space-y-3">
              <label className="text-xs font-bold text-green-700 uppercase">Horas Estimadas <span className="text-red-500">*</span></label>
              ...
              <label className="text-xs font-bold text-green-700 uppercase block mt-3">Lugar del Servicio <span className="text-red-500">*</span></label>
          ...
          {(formData.type === 'EXPERTISE' || formData.type === 'SERVICES') && (
            <div className="p-4 bg-purple-50 rounded-lg space-y-3">
              <label className="text-xs font-bold text-purple-700 uppercase">Habilidad Requerida <span className="text-red-500">*</span></label>
              ...
              <label className="text-xs font-bold text-purple-700 uppercase block mt-3">Lugar del Servicio <span className="text-red-500">*</span></label>
          ...
          {isEditMode && (
            <div className="p-4 bg-slate-100 rounded-lg space-y-1.5 border border-slate-200">
              <label className="text-xs font-bold text-slate-700 uppercase">Estado de la Petición <span className="text-red-500">*</span></label>
              <select 
                name="status" 
              ...
              >
                ...
                <option value="MATCHED">ASIGNADA (Coordinando entrega)</option>
